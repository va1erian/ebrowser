...
| 7 | A5 **partially done** (Wheel/IME/cursor/clipboard deferred, see §A5); ~~A7~~ **DONE**, A6 **partially done** (see §A6); B8 **partially done** (flags/mailbox-tree/unread-counts/multi-select/shortcuts landed, IDLE-on-selected-mailbox and special-use-flag wiring for Sent/Trash/Archive deferred, see §B8); **B9 — start here** | — |
